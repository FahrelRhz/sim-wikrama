                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="tanggal_pengadaan"
                                        ...
                                        value="{{ old('tanggal_pengadaan', \Carbon\Carbon::parse($barang->tanggal_pengadaan)->format('Y-m-d')) }}"
                                        required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="kondisi_barang" name="kondisi_barang" required>
                                        <option value="Baik"
                                            {{ old('kondisi_barang', $barang->kondisi_barang) == 'Baik' ? 'selected' : '' }}>
                                            Baik</option>
                                        <option value="Rusak"
                                            {{ old('kondisi_barang', $barang->kondisi_barang) == 'Rusak' ? 'selected' : '' }}>
                                            Rusak</option>
                                    </select>
